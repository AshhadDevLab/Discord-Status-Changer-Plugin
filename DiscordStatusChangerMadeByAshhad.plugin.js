//META{"name":"DiscordStatusChangerMadeByAshhad","source":"https://raw.githubusercontent.com/Ashhad776/Discord-Status-Changer-Plugin/master/DiscordStatusChangerMadeByAshhad.plugin.js","website":"https://github.com/Ashhad776/Discord-Status-Changer-Plugin"}*//

class DiscordStatusChangerMadeByAshhad {
	/* BD functions */
	getName() { return "DiscordStatusChangerMadeByAshhad"; }
	getVersion() { return "0.2.7"; }
	getAuthor() { return "Ashhad#7041"; }
	getDescription() { return "Custom Discord status changer. Be Horny!"; }

	SetData(key, value) {
		BdApi.setData("DiscordStatusChangerMadeByAshhad", key, value);
	}

	GetData(key) {
		return BdApi.getData("DiscordStatusChangerMadeByAshhad", key);
	}
	...
	load() {
		...
		this.modules = this.modules || (() => {
			let m = []
			webpackChunkdiscord_app.push([['DiscordStatusChangerMadeByAshhad'], {}, e => { m = m.concat(Object.values(e.c)) }])
			return m
		})();
